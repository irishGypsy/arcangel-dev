...
<div id="wrapper">
    ...
    <div class="inner_banner">
        ...
        <img class="img-responsive" src="https://www.arcangelbattery.com/uploads/banner/banner2087505024banner.jpg" alt="About Us">
        <div class="about_txt">
            <h2>About Us</h2>
                    ...
                    <div class="modal-body">
                        ...
                        <form method="post" id="login_form" class="form" autocomplete="off" novalidate="novalidate">
                            ...
                            <div class="col-xs-12">
                                ...
                                <!-- <span style="padding-left:10px;"><a href="https://www.facebook.com/dialog/oauth?client_id=251315198594952&redirect_uri=http%3A%2F%2Fwww.buyerbazaar.co.uk%2F&state=afbc16470da632b01ba0a091dcc7d178&scope=email"><img src="assets/front/images/FB-login.png" alt="Fblogin" ></a></span>-->
