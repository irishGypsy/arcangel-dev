            ...
            <div class="col-lg-8 m-lg-3">
                <table class="table table-bordered table-hover shopping-cart-wrap" style="font-family: FuturaPT-Light;font-size: large;">
                    ...
                    <tr style="text-align: center;">
                        <td style="text-align: center;">
                            <figure class="media">
                                <figcaption class="media-body">
                                    <p class="title text-truncate">Arc-Angel Group 49 Starting Battery - Out of Stock</p>
                                </figcaption>
                            </figure>
                        </td>
                        <td style="text-align: center;">
                        ...
                        <td class="text-right">
                            <a href="http://localhost:3000/cart/item/6139f1078e900/remove" class="btn btn-outline-danger"><i class="fa fa-times"></i> </a>
                        </td>
                    </tr>
                    <tr style="text-align: center;">
                        <td style="text-align: center;">
                            <figure class="media">
                                <figcaption class="media-body">
                                    <p class="title text-truncate">arc-angel group 48 starting battery</p>
                                </figcaption>
                            </figure>
                        </td>
                        <td style="text-align: center;">
                        ...
                        <td class="text-right">
                            <a href="http://localhost:3000/cart/item/6139f11c0454c/remove" class="btn btn-outline-danger"><i class="fa fa-times"></i> </a>
                        </td>
                    </tr>
                    </tbody>
                </table>
            ...
            <div class="col-lg-5 mt-3">
                <div class="border">
                    <div class="border d-flex flex-row justify-content-between p-2 ">
                        ...
                        <div class="">$ 420.00</div>
                    </div>
                    <br><br><br>
                    <div class="border bg-light d-flex flex-row justify-content-between p-3">
                        <div class="font-weight-bolder">Grand Total <div class="font-weight-light">(inclusive of all taxes)</div></div>
                        <div class="font-weight-bold"> $ 420.00</div>
                    </div><!-- end of boty -->
                </div>
            </div>
        </div>
        ...
        <div class="d-flex flex-row justify-content-around">
            ...
            <div class="col-lg-7 m-lg-3">
                <form id="" action="" method="post">
                    <div class="font-weight-bold p-2 border-light">Apply Coupon Code</div>
                    ...
                    <button type="button" title="Apply Coupon" class="button button-primary" style="height:40px" onclick="">Apply Coupon</button>
                </form>
            </div>

            <div class="col-lg-4 mt-3 d-flex flex-row justify-content-center p-2 border border-light border-top border-bottom" style="height:60px">
                <button href="#" type="button" style="height:40px" class="mx-2 p-2 py-1 button button-primary">Continue Shopping</button>
                <button href="#" type="button" style="height:40px" class="mx-2 p-2 py-1 button button-secondary">Checkout</button>
            </div>
...
{{--                            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12" style="width: 100% !important">--}}
{{--                                <div class="cart-block-wrapper">--}}
{{--                                    <div class="cart-block block">--}}
{{--                                        <form id="discount-coupon-form" action="" method="post">--}}
{{--                                            <div class="discount">--}}
