            ...
            <div class="tile">
                ...
                <form action="{{ route('admin.packages.store') }}" method="POST" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tile-body">
                        ...
                        <div class="form-group">
                            <label class="control-label" for="price_adjustment"> Price Adjustment <span class="m-l-5 text-danger"> *</span></label>
                            <input class="form-control @error('price_adjustment') is-invalid @enderror" type="text" name="price_adjustment" id="price_adjustment" value="{{ old('price_adjustment') }}"/>
